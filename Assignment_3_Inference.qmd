...
# Hint: Use the table() function on your two categorical variables
tiktok_party_table <- table(w144_wrangled$uses_tiktok, w144_wrangled$party_simple)

# Run the test
# Hint: Use the chisq.test() function on your table
...
# Run the t-test
# Hint: Use t.test(numeric_var ~ categorical_var, data = ...)
...
# Run the ANOVA
# Hint: Use aov(numeric_var ~ categorical_var, data = ...)
...
# Hint: Use TukeyHSD() on your anova_model
